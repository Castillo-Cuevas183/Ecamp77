...
('Excavadora', 'Máquina pesada para excavaciones', 1),
('Camión', 'Vehículo para transporte de materiales', 2),
('Grua', 'Máquina para levantar objetos pesados', 3),
('Tractor', 'Máquina agrícola', 4),
('Bulldozer', 'Máquina para nivelación de terreno', 5),
('Retroexcavadora', 'Máquina combinada para excavación y carga', 6),
('Perforadora', 'Máquina para perforación de suelos', 7),
('Cargadora', 'Máquina para carga de materiales', 8),
('Compactadora', 'Máquina para compactación de suelos', 9),
('Motoniveladora', 'Máquina para nivelación de superficies', 10);
