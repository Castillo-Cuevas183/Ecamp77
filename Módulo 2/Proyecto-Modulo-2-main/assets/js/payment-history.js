$(document).ready(function() {
    const paymentData = {
        1: [
            { concepto: 'Inscripción', monto: '$1000', fecha: '01/01/2024' },
            { concepto: 'Mensualidad Enero', monto: '$500', fecha: '15/01/2024' }
        ],
        2: [
            { concepto: 'Inscripción', monto: '$1000', fecha: '02/01/2024' },
            { concepto: 'Mensualidad Enero', monto: '$500', fecha: '16/01/2024' }
        ],
        3: [
            { concepto: 'Inscripción', monto: '$1000', fecha: '03/01/2024' },
            { concepto: 'Mensualidad Enero', monto: '$500', fecha: '17/01/2024' }
        ]
    };
